...
<html>
  ...
  <body class="hold-transition login-page">
    <div class="login-box" style="margin-top: 14px;">
      <div class="login-logo">
          <img src="app/dist/img/sl_logo.png" alt="" style="width: 90px;"/> <br/>
        <a href="app/index2.html"><b>HR System</b><br/> MASL Digana Division</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <br/>
        <form action="app/dashboard.php" method="post">
